...
class TestStrategy(unittest.TestCase):
    def test_bollinger_bands(self):
        ...
        for y in range(1):
            for x in range(4):
                ...
                buy_sell.implement_strategy(
                    account, coin_kline, price, close_time)
                if x == 0:
                    print("first test")
    ...
    #     account = RealTradingEnv(API_KEY, SECRET_KEY, COIN_UNIT)
    #     coin_kline = Coin(coin_unit=COIN_UNIT)
    #     buy_sell = Strategy(strategy='double_bottom')

    #     # Manufacture fake upper and lower bands based on current price
    #     upper_bands = [15, -5, 15, -5, 15, 35, 15, 35]
    #     lower_bands = [-15, -35, -15, -35, -15, 5, -15, 5]
